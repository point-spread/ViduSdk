...
#define PD_ERROR(fmt, ...)                                                                                             \
    ...
    {                                                                                                                  \
        CONSOLE_COLOR_SET(FOREGROUND_RED);                                                                             \
        fprintf(stderr, ANSI_COLOR_RED "[ERROR] : " fmt ANSI_COLOR_END, ##__VA_ARGS__);                                \
    } while (0)
#endif
...
#define PD_WARNING(fmt, ...)                                                                                           \
    ...
    {                                                                                                                  \
        CONSOLE_COLOR_SET(FOREGROUND_YELLOW);                                                                          \
        fprintf(stderr, ANSI_COLOR_YELLOW "[WARN] : " fmt ANSI_COLOR_END, ##__VA_ARGS__);                              \
    } while (0)
#endif
...
#define PD_INFO(fmt, ...)                                                                                              \
    ...
    {                                                                                                                  \
        CONSOLE_COLOR_SET(FOREGROUND_GREEN);                                                                           \
        fprintf(stderr, ANSI_COLOR_GREEN "[INFO] : " fmt ANSI_COLOR_END, ##__VA_ARGS__);                               \
    } while (0)
#endif
