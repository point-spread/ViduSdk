...
Powershell.exe -executionpolicy Bypass -Command "& '%cd%\camdriver\set_env_path.ps1' '%SDK_LIB_PATH%;%USERPROFILE%' 'ViduSdk-;ViduSdk_Internal-;Vidu_SDK_Api\SDKlib;DYV_SDK_Api\SDKlib;ViduSdk\SDKlib;ViduSdk_Internal\SDKlib;..\build\lib;OkuloSdk-windows\SDKlib;OkuloSdk\SDKlib;OkuloSdk_Internal\SDKlib' 'PATH' '%USE_ADMIN_ENV%'"
